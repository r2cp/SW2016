...
%   calds = calds_q;
%   nper = 4;
%   mlabel = '_mucsv_constAlpha_17c_Q0';  
  ...
  calds = calds_q;
  nper = 4;
  mlabel = '_mucsv_constAlpha_17c_Q3';
%   
%  % -- Read in Data --- 
%   load_data = 1;  % 1 if reloading data from Excel, etc 
%   mtoq_agg = 0;   % Temporal aggregation indicator of monthly to quarterly data
...
%   share_avg_xe = share_avg_xe_m;
%   calvec = calvec_m;
%   dnobs = dnobs_m;
%   calds = calds_m;
%   nper = 12;
%   mlabel = '_mucsv_constAlpha_17c_M';
...
%    alpha_tau = rand(notim,n_y);
  ...
  for idraw=1:n_burnin+n_draws;
    ...
    % Step 1.a.2 : Draw Factor Loadings 
     ...
     [alpha_eps, alpha_tau] = draw_alpha(dp_mat_n,prior_var_alpha,tau_unique,eps_common,tau_common,sigma_eps_unique_scl);
